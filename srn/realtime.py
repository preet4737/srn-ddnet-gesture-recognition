    ...
    def __init__(self, config):
        ...
        if self.test_dataset == 'kinect2':
            ...
            self.testData = loader.realtime_loader(self.data_dir, (615.866, 615.866, 316.584, 228.38),
                                        1500, cube_size=self.cube_size)
        elif self.test_dataset == 'dhg':
            self.testData = dhg.realtime_loader(self.data_dir, (615.866, 615.866, 316.584, 228.38),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='./data/essai1')
    parser.add_argument('--model_dir', type=str, default='./checkpoint/offset_000_240.pth')
    parser.add_argument('--train_dataset', default='hands17', type=str, choices=['nyu', 'icvl', 'msra','hands17','itop'])
    parser.add_argument('--test_dataset', default='dhg', type=str, choices=['kinect2','realsense','dhg'])
